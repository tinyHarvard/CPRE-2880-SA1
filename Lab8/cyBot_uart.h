...
// Split initialization: first half — enables UART1 clock and sets baud/frame registers.
// Call this, then configure GPIO Port B yourself, then call cyBot_uart_init_last_half().
void cyBot_uart_init_clean(void);

// Split initialization: second half — enables UART1 Tx/Rx after GPIO has been configured.
