...
#define SERVO_CAL_RIGHT      264250 /* Pulse width for 0° (rightmost)  */
#define SERVO_CAL_LEFT      1198750    /* Pulse width for 180° (leftmost) */
...
static void print_menu(void)
{
    ...
    uart_sendStr("  'c' = Enter calibration mode\r\n");
    uart_sendStr("  'q' = Quit\r\n");
    uart_sendStr("=========================================\r\n\r\n");
}
...

{
   ...
   // char msg[120];
    ...
    while (1)
    {
        ...
        int hhh= select_gap(gap,gap_count, 90);
        char line[120];
        sprintf(line, "chosen gap: %d Angle: %f   \r\n",
                   hhh+1,gap[hhh].chosen_movement_angle );
             uart_sendStr(line);
        ...
        case 'g':
            nav_auto_drive(sensor_data,100,90);
            print_menu();
            break;
